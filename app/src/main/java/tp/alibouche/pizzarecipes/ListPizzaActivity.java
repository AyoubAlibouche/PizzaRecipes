...
import tp.alibouche.pizzarecipes.adapter.PizzaAdapter;
...
public class ListPizzaActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        final TextView idpd = view.findViewById(R.id.idp);
        TextView nom = view.findViewById(R.id.nom);
        //Toast.makeText(this, idpd.getText().toString() + " " nom.getText().toString(), Toast.LENGTH_SHORT).show();
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(this);
        alertDialogBuilder.setMessage("veullez choisir une option :");

        alertDialogBuilder.setPositiveButton("Supprimer", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                ps.delete(ps.findById(Integer.parseInt(idpd.getText().toString())));
                liste.setAdapter(new PizzaAdapter(ListPizzaActivity.this, ps.findAll()));
        ...
        alertDialogBuilder.setNegativeButton("Details", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                intent.putExtra("idp", idpd.getText().toString());
